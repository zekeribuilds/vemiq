      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-background-secondary via-background to-background-tertiary py-12 sm:py-16 md:py-20 lg:py-24 px-3 sm:px-4 md:px-8 lg:px-16 pt-32 sm:pt-32 md:pt-40 lg:pt-48">
        ...
        <div className="relative">
          <div className="text-center mb-8 sm:mb-12 animate-fade-in-up">
            <h1 className="text-3xl sm:text-lg md:text-3xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6 leading-tight">
              <span className="whitespace-nowrap">Document Your SIWES Today</span><br />
              <span className="text-2xl sm:text-base md:text-2xl lg:text-4xl block mt-0" style={{ color: '#8661ff' }}>Generate Your Report Tomorrow</span>
            </h1>
